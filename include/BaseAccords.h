...
// Classe BaseAccords : contient les informations sur les accords pour differentes tonalites
class BaseAccords
{
public:
     ...
     */
    std::vector<int> obtenirAccord(const std::string &tonalite, const std::string &degre) const;
