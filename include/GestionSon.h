 ...
 *
 * Cette classe permet de gerer la lecture des sons associes aux notes
 * musicales. Elle utilise un fichier audio specifique pour chaque note.
 */
class GestionSon : public QObject {
  ...
  public:
     ...
     *
     * Cette methode construit le chemin du fichier audio correspondant a la
     * note et le lit en utilisant une commande externe.
     *
