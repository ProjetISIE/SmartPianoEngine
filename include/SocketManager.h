...
public:
     ...
     * 
     * @param message Message au format QJsonObject a envoyer au client connecte.
     */
     ...
     * 
     * @return Le message recu sous forme de QString, ou une chaine vide en cas d'erreur.
     */
