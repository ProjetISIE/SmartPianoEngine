...
TEST_CASE("GameEngine workflow") {
    // Teste le flux complet du moteur de jeu : configuration, démarrage, interaction, et arrêt.
    // Ce test simule le cycle de vie typique d'une session pour s'assurer de la cohérence des états.
